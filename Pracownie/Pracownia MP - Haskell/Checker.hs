...
-- Jeœli chcesz by by³ wyœwietlany czas dzia³ania programu, to:
-- 1. zainstaluj pakiet timeit:
--    $ cabal install timeit
-- 2. odkomentuj nastêpny wiersz:
-- import System.TimeIt
-- 3. zakomentuj nastêpny wiersz:
timeIt = id

-- Tutaj wybierz czas na jaki jest uruchamiany jeden test
-- Just t  oznacza uruchomienie na t sekund
-- Nothing oznacza oczekiwanie na zakoñczenie dzia³ania
timeout :: Maybe Int
timeout = Just 5
